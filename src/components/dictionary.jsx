...
export default function Dictionary(){
    ...
    return(
        <div className="bg-slate-100 text-xl p-4 rounded-2xl border-2 grid grid-cols-2 grid-rows-6 max-w-xl md:row-span-3">
            ...
            <div className="col-span-2 row-span-5 p-6 my-6 rounded-2xl bg-slate-400">
                ...
                <small>({speech})</small>
                <p className ="my-2"><span className=" font-bold">Definition: </span>{definition}</p>
                <p className ="my-2"> <span className=" font-bold">Example: </span>{example}</p>
            </div>
        </div>
    )
}